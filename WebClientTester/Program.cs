...
namespace WebClientTester
{
    class Program
    {
        private static Uri _productReservationServiceUri = new Uri("http://localhost:2444/Reservation");
        private static Uri _productPurchaseServiceUri = new Uri("http://localhost:2444/Purchase");
